...
public class Double3 {
    ...
    public boolean double3TestBetweenDoubles(double d) {
        if (this.d1 > d && this.d2 > d && this.d3 > d) return true;
        return false;
    }
    ...
    /**
     * Scale (multiply) Double3 triad by a number into a new triad where each
     * number is multiplied by the number
     *
     * @param rhs right handle side operand for scaling
     * @return result of scale
