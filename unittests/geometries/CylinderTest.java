...
//        Cylinder cylinder = new Cylinder(new Ray(new Point(2, 0, 0), new Vector(new Double3(0,0,1))), 2, 1);
//        List<Point> result;
//        // ============ Equivalence Partitions Tests==============
//        // **** Group: ray start are same level q0(start of cylinder)
//        // TC01: Ray's line is outside the cylinder (0 points)
//        result = cylinder.findIntersections(new Ray(new Point(6, 0, 0), new Vector(-6, 5, 0)));
//        assertEquals("TC01: Ray's line is outside the cylinder", null, result);
//
//        // TC02: Ray starts before and crosses the cylinder (2 points)
//        result = cylinder.findIntersections(new Ray(new Point(0, 4, 0), new Vector(2, -2, 0)));
...
//        result = cylinder.findIntersections(new Ray(new Point(1, 1, 0), new Vector(1, 1, 0)));
//        assertNull("TC02:empty list", result);
//        // assertEquals("TC03: Ray starts inside the cylinder", List.of(new Point(2,
//        // 2, 0)), result);
//
...
//        Cylinder cylinder1 = new Cylinder(new Ray(new Point(2, 0, -1), new Vector(new Double3(0,0,1))), 2, 2);
//        // TC17: Ray's line is outside the cylinder (0 points)
//        result = cylinder1.findIntersections(new Ray(new Point(6, 0, 0), new Vector(-6, 5, 0)));
...
//        result = cylinder1.findIntersections(new Ray(new Point(0, 4, 0), new Vector(2, -2, 0)));
...
//        result = cylinder1.findIntersections(new Ray(new Point(1, 1, 0), new Vector(1, 1, 0)));
//        assertEquals("TC19: Ray starts inside the cylinder (1 point)", List.of(new Point(new Double3(2,2,0))), result);
//        // TC20: Ray starts after the cylinder (0 points)
//        result = cylinder1.findIntersections(new Ray(new Point(5, 0, 0), new Vector(1, 0, 0)));
...
//        result = cylinder.findIntersections(new Ray(new Point(4, 0, 0), new Vector(-2, 2, 0)));
//        assertNull("TC02:empty list", result);
...
//        result = cylinder.findIntersections(new Ray(new Point(4, 0, 0), new Vector(1, 0, 0)));
...
//        result = cylinder.findIntersections(new Ray(new Point(2, -4, 0), new Vector(0, 6, 0)));
//        assertNull("TC07:empty list", result);
//        // TC08: Ray starts at cylinder and goes inside (0 points)
//        result = cylinder.findIntersections(new Ray(new Point(2, -2, 0), new Vector(0, 6, 0)));
//        assertNull("TC08:empty list", result);
//        // TC09: Ray starts inside (0 points)
//        result = cylinder.findIntersections(new Ray(new Point(2, -1, 0), new Vector(0, 6, 0)));
//        assertNull("TC09:empty list", result);
//        // TC10: Ray starts at the center (0 points)
//        result = cylinder.findIntersections(new Ray(new Point(2, 0, 0), new Vector(0, 6, 0)));
...
//        result = cylinder.findIntersections(new Ray(new Point(2, 3, 0), new Vector(0, 6, 0)));
...
//        result = cylinder.findIntersections(new Ray(new Point(4, -2, 0), new Vector(-4, 0, 0)));
//        assertEquals(" TC13: Ray starts before the tangent point", null, result);
//        // TC14: Ray starts at the tangent point
//        result = cylinder.findIntersections(new Ray(new Point(2, -2, 0), new Vector(-4, 0, 0)));
//        assertEquals("  TC14: Ray starts at the tangent point", null, result);
//        // TC15: Ray starts after the tangent point
//        result = cylinder.findIntersections(new Ray(new Point(1, -2, 0), new Vector(-4, 0, 0)));
...
//        // center
//        // line
//        result = cylinder.findIntersections(new Ray(new Point(2, -4, 0), new Vector(-4, 0, 0)));
...
//        result = cylinder1.findIntersections(new Ray(new Point(4, 0, 0), new Vector(-2, 2, 0)));
//        assertEquals(" TC21:Ray starts at cylinder and goes inside (1 points)", List.of(new Point(2, 2, 0)), result);
//        // TC22: Ray starts at cylinder and goes outside(0 points)
//        result = cylinder1.findIntersections(new Ray(new Point(4, 0, 0), new Vector(1, 0, 0)));
...
//        result = cylinder1.findIntersections(new Ray(new Point(2, -4, 0), new Vector(0, 6, 0)));
//        assertEquals(" TC23: Ray starts before the cylinder (2 points)",
//                List.of(new Point(2, -2, 0), new Point(2, 2, 0)), result);
//        // TC24: Ray starts at cylinder and goes inside (1 points)
//        result = cylinder1.findIntersections(new Ray(new Point(2, -2, 0), new Vector(0, 6, 0)));
//        assertEquals(" TC24: Ray starts at cylinder and goes inside (1 points)", List.of(new Point(2, 2, 0)), result);
//        // TC25: Ray starts inside (1 points)
//        result = cylinder1.findIntersections(new Ray(new Point(2, -1, 0), new Vector(0, 6, 0)));
//        assertEquals(" TC25: Ray starts inside (1 points)", List.of(new Point(2, 2, 0)), result);
//        // TC26: Ray starts at the center (1 points)
//        result = cylinder1.findIntersections(new Ray(new Point(2, 0, 0), new Vector(0, 6, 0)));
//        assertEquals(" TC26: Ray starts at the center (1 points)", List.of(new Point(2, 2, 0)), result);
...
//        result = cylinder1.findIntersections(new Ray(new Point(2, 3, 0), new Vector(0, 6, 0)));
...
//        result = cylinder1.findIntersections(new Ray(new Point(4, -2, 0), new Vector(-4, 0, 0)));
//        assertEquals("TC29: Ray starts before the tangent point", null, result);
//        // TC30: Ray starts at the tangent point
//        result = cylinder1.findIntersections(new Ray(new Point(2, -2, 0), new Vector(-4, 0, 0)));
//        assertEquals(" TC30: Ray starts at the tangent point", null, result);
//        // TC31: Ray starts after the tangent point
//        result = cylinder1.findIntersections(new Ray(new Point(1, -2, 0), new Vector(-4, 0, 0)));
...
//        result = cylinder1.findIntersections(new Ray(new Point(2, -4, 0), new Vector(-4, 0, 0)));
//        assertEquals("  TC32: Ray's line is outside, ray is orthogonal to ray start to cylinder's center line", null,
//                result);
//
//        // new data
//        Cylinder cylinder2 = new Cylinder(new Ray(new Point(2, 0, 0), new Vector(new Point(0, 0, 1))), 2, 3);
//
...
//        // Bounder up(2 point)
//        result = cylinder2.findIntersections(new Ray(new Point(0, 0, -3), new Vector(2, 0, 3)));
//        assertEquals("TC33: Ray starts inside the tube", List.of(new Point(2, 0, 0), new Point(4, 0, 3)), result);
//        // TC34: Ray starts up the cylinder intersect whit the base up and
//        // base down(2 point)
//        result = cylinder2.findIntersections(new Ray(new Point(2, 2, 4.5), new Vector(0, -2, -3)));
//        assertEquals("TC34: Ray starts inside the tube", List.of(new Point(2, -1, 0), new Point(2, 1, 3)), result);
//        // TC39:ray intersect the sides and the base up (not in the center)(2 point)
//        result = cylinder2.findIntersections(new Ray(new Point(2.5, 3.5, 0), new Vector(-0.5, -1.5, 1)));
//        assertEquals("TC39: Ray starts inside the tube", List.of(new Point(1, -1, 3), new Point(2, 2, 1)), result);
//        // TC40:ray intersect the sides (trohw in the center(not the start ray))(2
//        // point)
//        result = cylinder2.findIntersections(new Ray(new Point(8, 0, 0), new Vector(-4, 0, 1)));
//        assertEquals("TC40: Ray starts inside the tube", List.of(new Point(4, 0, 1), new Point(0, 0, 2)), result);
//
//        // **** Group: Ray perapell to dir of cylinder *******
//        // TC35: Ray perapell to dir of cylinder outside the cylinder(0 point)
//        result = cylinder2.findIntersections(new Ray(new Point(0, 5, 0), new Vector(0, 0, 1)));
//        assertEquals("TC35: Ray starts inside the tube", null, result);
//        // TC36: ray start in low base and parepel to the axis(1 point)
//        result = cylinder2.findIntersections(new Ray(new Point(1, 1, 0), new Vector(0, 0, 1)));
//        assertEquals("TC36: Ray starts inside the tube", List.of(new Point(1, 1, 3)), result);
//        // TC37: ray start in cylinder base and parepel to the axis(1 point)
//        result = cylinder2.findIntersections(new Ray(new Point(1, 1, 1), new Vector(0, 0, 1)));
//        assertEquals("TC37: Ray starts inside the tube", List.of(new Point(1, 1, 3)), result);
//        // TC38: ray start out cylinder(befor) base and parepel to the axis(1 point)
//        result = cylinder2.findIntersections(new Ray(new Point(1, 1, -1), new Vector(0, 0, 1)));
//        assertEquals("TC38: Ray starts inside the tube", List.of(new Point(1, 1, 0), new Point(1, 1, 3)), result);
//
//    }
//
//    /**
...
//        Cylinder cylinder2 = new Cylinder(new Ray(new Point(2, 0, 0), new Vector(new Double3(0,0,1))), 2, 3);
//        // TC01: Ray starts befor the cylinder intersect with the center down and
//        // Bounder up(2 point)
//        result = cylinder2.findGeoIntersections(new Ray(new Point(0, 0, -3), new Vector(2, 0, 3)),5);
//        assertEquals("TC01: Ray starts inside the cylinder", new Point(2, 0, 0), result.get(0).point);
//        // TC02: Ray starts up the cylinder intersect whit the base up and
//        // base down(2 point)
//        result = cylinder2.findGeoIntersections(new Ray(new Point(2, 2, 4.5), new Vector(0, -2, -3)),3);
//        assertEquals("TC02: Ray starts inside the cylinder", new Point(2, 1, 3), result.get(0).point);
//        // TC03:ray intersect the sides and the base up (not in the center)(2 point)
//        result = cylinder2.findGeoIntersections(new Ray(new Point(2.5, 3.5, 0), new Vector(-0.5, -1.5, 1)),2);
//        assertEquals("TC03: Ray starts inside the cylinder", new Point(2, 2, 1), result.get(0).point);
//        // TC04:ray intersect the sides (trohw in the center(not the start ray))(2
//        // point)
//        result = cylinder2.findGeoIntersections(new Ray(new Point(8, 0, 0), new Vector(-4, 0, 1)),5);
//        assertEquals("TC04: Ray starts inside the cylinder", new Point(4, 0, 1), result.get(0).point);
//    }
//}