...
public class TenOrMoreShapesTests {
    ...
    public void newtonsCradle() {
        ...
        Render render = new Camera().setImageWriter(imageWriter).setCamera(cam).setRayTracer(new RayTracerBasic(scene));

        render.renderImage();
        render.writeToImage();

        render = render
                .setCamera(cam.setPosition(new Point(0, 100000, 100000)).setCameraHead(new Point(0, 0, 500))
        ...
        render = render
                .setCamera(cam.setPosition(new Point(-7000, 20000, 40000)).setCameraHead(new Point(0, 0, 500))
                        .setVPDistance(Math.sqrt(10000 * 10000 + 2000 * 2000) * 2 * 2))
                .setImageWriter(new ImageWriter("Newton's cradle position 3", 500, 500));
        render.renderImage();
        render.writeToImage();
        render = render
                .setCamera(cam.setPosition(new Point(-10000, -10000, 40000)).setCameraHead(new Point(0, 0, 0))
        ...
        render.writeToImage();
        render = render
                .setCamera(new Camera(new Point(0, 10000, 5200), new Vector(0, -1, -0.5), new Vector(0, -0.5, 1))
                        .setVPDistance(13900.13562).setVPSize(2000, 2000).setCameraHead(new Point(0, 0, 500))
