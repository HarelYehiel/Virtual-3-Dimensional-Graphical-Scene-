...
public class LightsTests {
	...
	public void sphereSpotSharp() {
		scene1.geometries.add(sphere);
		scene1.lights
				.add(new SpotLight(spCL, spPL, new Vector(1, 1, -0.5)).setSharp(10).setKl(0.001).setKq(0.00004));
	...
	public void trianglesSpotSharp() {
		scene2.geometries.add(triangle1, triangle2);
		scene2.lights.add(new SpotLight(trCL, trPL, trDL).setSharp(10).setKl(0.001).setKq(0.00004));
